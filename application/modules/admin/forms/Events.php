 ...
 * @author miholeus
 */
class Admin_Form_Events extends Admin_Form_Template_Simple
{
    ...
    public function init()
    {
        ...
        // image
        $image = $this->createElement('text', 'img_preview');
        $image->setLabel('Image Preview');
        $image->setAttrib('size', '80%');
