...
class Soulex_View_Helper_TinyMce extends Zend_View_Helper_Abstract
{
    ...
    protected $_defaultScript = '/_data/default/js/tiny_mce/tiny_mce.js';
    protected $_tinyBrowserScript = '/_data/default/js/tiny_mce/plugins/tinybrowser/tb_tinymce.js.php';
